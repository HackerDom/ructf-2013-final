...
CREATE TABLE teams (
    ...
    flag_price  INTEGER         NOT NULL DEFAULT 1
);
...
CREATE TABLE flag_price (
    ...
    rank        REAL            NOT NULL,
    rank_def    REAL            NOT NULL,
    rank_att    REAL            NOT NULL
);
            ...
            xmlelement(
                ...
                FROM
                    (SELECT
                        xmlconcat(
                            xmlelement(
                                name team, xmlattributes(teams.name as name, teams.vuln_box as "vulnBox", teams.flag_price as flag_price),
                                (SELECT
                                    xmlelement(
                                        name scores,
